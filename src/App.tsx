...
function App() {
  ...
  const animationConfig = getAnimationConfig(performance.deviceType, performance.prefersReducedMotion);
  ...
  const enableAdvancedFeatures = performance.deviceType !== 'low' && !performance.prefersReducedMotion;
  ...
  return (
    <div className={`app-container relative min-h-screen ${darkMode ? 'dark' : 'light'}`}>
      <PerformanceMonitor />
      ...
      {enableAdvancedFeatures && (
        <div className="fixed inset-0 -z-10">
          <Suspense fallback={<div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900"></div>}>
            <ThreeJSBackground 
              darkMode={darkMode} 
      ...
      {enableAdvancedFeatures && !performance.isTouchDevice && responsive.isDesktop && (
      ...
      <main className="relative z-10">
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin w-8 h-8 border-4 border-purple-500 border-t-transparent rounded-full"></div></div>}>
          <SkillsSection 
            darkMode={darkMode} 
            skills={skills} 
            visibleElements={visibleElements}
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin w-8 h-8 border-4 border-emerald-500 border-t-transparent rounded-full"></div></div>}>
          <ExperienceSection 
            darkMode={darkMode} 
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin w-8 h-8 border-4 border-pink-500 border-t-transparent rounded-full"></div></div>}>
          <ProjectsSection 
            darkMode={darkMode} 
            projects={projects} 
            visibleElements={visibleElements}
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin w-8 h-8 border-4 border-rose-500 border-t-transparent rounded-full"></div></div>}>
          <ContactSection 
            darkMode={darkMode} 
            visibleElements={visibleElements}
          />
