...
const ExperienceSection: React.FC<ExperienceSectionProps> = ({ darkMode, experiences, visibleElements }) => {
  ...
  const enhancedExperiences = [
    {
      ...
      companyLogo: '🏢',
      highlights: ['Team Lead', 'Architecture Design', 'Performance Optimization']
    },
    {
      ...
      companyLogo: '🌟',
      highlights: ['Full Stack Development', 'API Integration', 'Database Optimization']
    },
    {
      ...
      companyLogo: '🚀',
      highlights: ['Learning & Growth', 'Team Collaboration', 'Agile Development']
    }
  ];

  const displayExperiences = experiences.length > 0 ? experiences : enhancedExperiences;
        ...
        <div className="w-full">
          ...
          <div className="text-center mb-20">
            <motion.div
              ...
              className="mb-6"
            >
              <span className="inline-block px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-emerald-500/10 to-blue-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 mb-4">
                Professional Journey
              </span>
              <h2 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                Work <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600">Experience</span>
              </h2>
            </motion.div>
            ...
            >
              ...
              <span className="text-emerald-600 dark:text-emerald-400 font-medium"> technology</span> and
              <span className="text-blue-600 dark:text-blue-400 font-medium"> teams</span>.
            </motion.p>
          </div>
          ...
          <div className="timeline-container relative">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-emerald-500 via-blue-500 to-purple-500 rounded-full timeline-line" style={{ height: '0%' }}></div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="timeline-dot absolute left-1/2 transform -translate-x-1/2 z-20">
                      <div className={`w-6 h-6 rounded-full bg-gradient-to-r ${(exp as any).color} shadow-lg`}>
                        <div className="w-full h-full rounded-full bg-white dark:bg-gray-900 scale-50"></div>
                      </div>
                      <div className={`absolute inset-0 w-6 h-6 rounded-full bg-gradient-to-r ${(exp as any).color} animate-ping opacity-20`}></div>
                    </div>

                    {/* Experience Card */}
                    <div className={`experience-card-${index} flex-1 ${isLeft ? 'lg:pr-16' : 'lg:pl-16'} lg:w-1/2`}>
                      <div className="relative p-8 rounded-3xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-white/20 dark:border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-500">
                        ...
                        <div className="flex items-center justify-between mb-6">
                          <div className="flex items-center space-x-4">
                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${(exp as any).color} p-4 text-white text-2xl flex items-center justify-center shadow-lg`}>
                          ...
                          <div className="text-right">
                            <div className={`px-3 py-1 rounded-full text-sm font-semibold bg-gradient-to-r ${(exp as any).color} text-white mb-2`}>
                        ...
                        {(exp as any).highlights && (
                          <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(exp as any).highlights.map((highlight: string, idx: number) => (
                                <span
                                  key={idx}
                                  className="px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300"
                                >
                                  {highlight}
                                </span>
                              ))}
                          ...
                          <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(exp as any).technologies.map((tech: string, idx: number) => (
                                <span
                                  key={idx}
                                  className="px-3 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300"
                                >
                                  {tech}
                                </span>
                              ))}
                    ...
                    <div className={`hidden lg:block flex-1 ${isLeft ? 'lg:pl-16' : 'lg:pr-16'} lg:w-1/2`}>
