...
import { Calendar, MapPin, Star, Building, ChevronRight } from "lucide-react";
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            Explore my professional evolution from junior developer to tech
            leadership, highlighting key milestones and achievements along the
            way.
          </p>
        </motion.div>
        ...
        <div ref={timelineRef} className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 md:transform md:-translate-x-1/2">
            <div className="timeline-path w-1 h-full bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 rounded-full shadow-lg relative overflow-hidden">
          ...
          <div className="space-y-16 md:space-y-24">
            {displayExperiences.map((experience, index) => (
              ...
              >
                {/* Timeline Marker */}
                <div
                  className={`milestone-marker-${index} absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 z-20`}
                >
                  <motion.div
                  ...
                  >
                    ...
                    {/* Pulse ring */}
                    <div
                      className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${experience.color} opacity-30 animate-ping`}
                    ></div>
        ...
        >
          <div
            className={`grid md:grid-cols-3 gap-8 p-8 rounded-3xl backdrop-blur-sm border ${
              darkMode
